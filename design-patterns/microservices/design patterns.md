...
It is an **orchestration pattern** used to combine multiple business processes into a single API call for clients.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg5NzUwOTk2OSw1Njg5MzQ3MTYsNDc1NT
